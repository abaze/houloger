    ...
    <b-row class="mt-5 mb-5">
      <b-col class="relative">
        <h1 v-if="annonces" class="text-center">
          ...
          >
          <span v-else>Nos biens disponibles à la location</span>
...
export default {
  ...
  methods: {
    getAnnonces() {
      this.$axios
        .$get(
          'https://site-immo.abaze-de-donnees.fr/wp-json/api/annonces/search/?vente_location=location'
        )
        .then((response) => {
          // on ajoute le champ "isReady" à la reponse de l'api
